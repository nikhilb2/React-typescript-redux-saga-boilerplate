import { currentSession, getJwt } from './redux/auth/UserSession'

const API_ROOT = 'https://zefiri.com/api'
export const IMAGE_API_ROOT = 'https://zefiri.com/api/'
const IMAGE_UPLOAD_API_ROOT = `https://zefiri.com/api/upload.php`
const dev = false
...
export default function request(url, options, addauth, addSign = '&') {
  ...
  if (addauth && jwt) {
    ...
    decoratedOptions.headers.Authorization = 'Bearer ' + jwt
